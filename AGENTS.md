...
- Out of v1 scope: complex dashboards, doctor signup/onboarding (creating `doctor_profiles` rows), doctor discovery. AI scribe (transcript → draft SOAP note) is v1.5.
