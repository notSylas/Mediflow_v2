...
const SESSION_ROUTES: Route[] = [
  ...
  ["GET", "/api/v1/patient/care"],
  ["POST", "/api/v1/patient/care"],
  ["PATCH", "/api/v1/patient/care"],
  ["DELETE", "/api/v1/patient/care"],
  ["GET", "/api/v1/patient/care/cancellation"],
  ["POST", "/api/v1/patient/care/follow-up"],
...
const DOCTOR_ROUTES: Route[] = [
  ...
  ["GET", "/api/v1/doctor/care-subscriptions"],
  ["POST", `/api/v1/doctor/care-subscriptions/${UID}`],
  ["POST", `/api/v1/doctor/care-follow-ups/${UID}`],
